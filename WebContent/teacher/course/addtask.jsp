...
<html>
  ...
  <body>
  	<h2 style="text-align: center;">作业上传</h2>
  	<div id="content">
  	<br/>
  	<div style="text-align: right;">
  	 ...
  	 <form action="${pageContext.request.contextPath}/servlet/TaskServlet?method=addTask" method="post" enctype="multipart/form-data">
